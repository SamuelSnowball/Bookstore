...
import com.example.database.generated.tables.Author.AuthorPath;
...
public class Book extends TableImpl<BookRecord> {
    ...
    /**
     * The column <code>mydatabase.book.price</code>.
     */
    public final TableField<BookRecord, BigDecimal> PRICE = createField(DSL.name("price"), SQLDataType.DECIMAL(10, 2).defaultValue(DSL.inline("0.00", SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>mydatabase.book.description</code>.
     */
    ...
    public BookOrdersPath bookOrders() {
        if (_bookOrders == null)
            _bookOrders = new BookOrdersPath(this, null, Keys.BOOK_ORDERS_IBFK_2.getInverseKey());
    ...
    public CartItemPath cartItem() {
        if (_cartItem == null)
            _cartItem = new CartItemPath(this, null, Keys.CART_ITEM_IBFK_2.getInverseKey());
     ...
     * <code>mydatabase.user</code> table
     */
