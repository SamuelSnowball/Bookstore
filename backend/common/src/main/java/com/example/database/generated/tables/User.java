...
import com.example.database.generated.tables.CartItem.CartItemPath;
import com.example.database.generated.tables.Orders.OrdersPath;
import com.example.database.generated.tables.UserAddress.UserAddressPath;
...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The column <code>mydatabase.user.username</code>.
     */
    ...
    /**
     * The column <code>mydatabase.user.password</code>.
     */
    public final TableField<UserRecord, String> PASSWORD = createField(DSL.name("password"), SQLDataType.VARCHAR(255).nullable(false).defaultValue(DSL.inline("$2a$12$jd0nX4mZ4kChbc3jwaFCD.DVcvopRU/Bct.jJgh94kkHyztrgMfHS", SQLDataType.VARCHAR)), this, "");
    ...
    private transient CartItemPath _cartItem;

    /**
     * Get the implicit to-many join path to the
     * <code>mydatabase.cart_item</code> table
     */
    public CartItemPath cartItem() {
        if (_cartItem == null)
            _cartItem = new CartItemPath(this, null, Keys.CART_ITEM_IBFK_1.getInverseKey());

        return _cartItem;
    }

    private transient UserAddressPath _userAddress;

    /**
     * Get the implicit to-many join path to the
     * <code>mydatabase.user_address</code> table
     */
    public UserAddressPath userAddress() {
        if (_userAddress == null)
            _userAddress = new UserAddressPath(this, null, Keys.FK_USER_ADDRESS_USER.getInverseKey());
    ...
    /**
     * Get the implicit to-many join path to the <code>mydatabase.orders</code>
     * table
     */
     ...
     * <code>mydatabase.book</code> table
     */
